...
| --- | --- | --- |
| Node test image | `node:22.22.2-alpine` | Satisfies the current Node engine floor and Cypress transitive engine requirements, and is supported by Vitest 4.1.11 and Cypress 16.0.0. |
...
| Cypress | `16.0.0` | Supports Node 20, 22, and 24 lines and contains the Firefox AUT-context correction required by the pinned browser matrix. |
