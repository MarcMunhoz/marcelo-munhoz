...
- [x] 9.5 When production-like behavior must be verified, push to `staging` and complete the documented smoke checks before merging onward. Staging smoke is partially complete; see `staging-handoff.md` for confirmed behavior and the remaining Cloudinary media-library diagnostic.
